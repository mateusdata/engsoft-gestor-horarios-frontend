        ...
        <div id="application-sidebar-dark"
          ...
          <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul className="space-y-1.5">
              <li>
                <Link onClick={()=> {setCurrentPage(1)}} to={"/"} className={`flex items-center gap-x-3 py-2 px-2.5 ${currenPage ===1 && "bg-[#0a5f9b]  dark:bg-blue-700 " } hover:bg-gray-800 text-sm   dark:text-white rounded-md`}>

    ...
    <div>
      <body className="bg-gray-50 dark:bg-[#EFEFEF]">
        ...
        <div id="application-sidebar-dark"
          className={`${showMenu ? "hs-overlay border bg-[#238672] dark:bg-[#238662] hs-overlay-open:translate-x-0 -translate-x-full hidden transition-all duration-300 transform "
          ...
          <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap " data-hs-accordion-always-open>
            <ul className="space-y-1.5">
              <li>
                <Link onClick={()=> {setCurrentPage(1)}} to={"/"} className={`flex items-center gap-x-3 py-2 px-2.5 ${currenPage ===1 && "bg-[#0a5f9b]  dark:bg-blue-700 " } hover:bg-gray-800 text-sm text-white rounded-md`}>
              ...
              <li className="hs-accordion" id="users-accordion">
                <Link onClick={()=> {setCurrentPage(2)}} to={"/"} className={` ${currenPage ===2 && "bg-[#0a5f9b]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white`}>
                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div id="users-accordion-child" className="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                  <ul className="hs-accordion-group pl-3 pt-2" data-hs-accordion-always-open>
                    <li className="hs-accordion" id="users-accordion-sub-1">
                      <Link onClick={()=> {setCurrentPage(3)}} to={"/"} className={` ${currenPage === 3 && "bg-[#0a5f9b]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white`}>
                        Sub Menu 1
              ...
              <li className="hs-accordion" id="projects-accordion">
                <Link onClick={()=> {setCurrentPage(4)}} to={"/register"} className={` ${currenPage === 4 && "bg-[#0a5f9b]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white`}>
                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li>
                <Link onClick={()=> {setCurrentPage(5)}} to={"/"} className={` ${currenPage === 5 && "bg-[#0a5f9b]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white`}>
                <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li><Link onClick={()=> {setCurrentPage(6)}} to={"/"} className={` ${currenPage === 6 && "bg-[#0a5f9b]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-50 rounded-md hover:bg-gray-800 hover:text-white`}>
                <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">

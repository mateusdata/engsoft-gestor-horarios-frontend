        ...
        <div id="application-sidebar-dark"
          ...
          <nav className="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul className="space-y-1.5">
              <li>
                <Link onClick={()=> {setCurrentPage(1)}} to={"/table"} className={`flex items-center gap-x-3 py-2 px-2.5 ${currenPage ===1 && "bg-[#D9D9D9]  dark:bg-blue-700 " } hover:bg-[#ADD1A7] hover:text-white text-sm text-black rounded-md`}>
              ...
              <li className="hs-accordion" id="users-accordion">
                <Link onClick={()=> {setCurrentPage(2)}} to={"/teachers"} className={` ${currenPage ===2 && "bg-[#D9D9D9]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm  dark:text-white rounded-md hover:bg-[#ADD1A7] hover:text-white`}>
                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li className="hs-accordion" id="account-accordion">
                <Link onClick={()=> {setCurrentPage(3)}} to={"/"} className={` ${currenPage === 3  && "bg-[#D9D9D9]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm dard rounded-md hover:bg-[#ADD1A7] hover:text-white`}>
                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li className="hs-accordion" id="projects-accordion">
                <Link onClick={()=> {setCurrentPage(4)}} to={"/register"} className={` ${currenPage === 4 && "bg-[#D9D9D9]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm dard rounded-md hover:bg-[#ADD1A7] hover:text-white`}>
                  <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li>
                <Link onClick={()=> {setCurrentPage(5)}} to={"/"} className={` ${currenPage === 5 && "bg-[#D9D9D9]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm dard rounded-md hover:bg-[#ADD1A7] hover:text-white`}>
                <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              ...
              <li><Link onClick={()=> {setCurrentPage(6)}} to={"/"} className={` ${currenPage === 6 && "bg-[#D9D9D9]  dark:bg-blue-700 "}  hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm dard rounded-md hover:bg-[#ADD1A7] hover:text-white`}>
                <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">

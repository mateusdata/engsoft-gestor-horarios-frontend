...
const Footer = () => {
  return (
    <div className='bg-[EFEFEF] dark:bg-[#EFEFEF]'>
        <hr  className='w-full'/>
        <footer>
        <div className="max-w-[85rem] lg-w-full  mt-3    mb-5 px-4 sm:px-6 lg:px-8 mx-auto">
            ...
            <div>
                <a href='https://github.com/mateusdata/engsoft-gestor-horarios-frontend' className="flex-none text-xl font-semibold text-black dark:text-blacc" aria-label="Brand">IFBA</a>
            </div>

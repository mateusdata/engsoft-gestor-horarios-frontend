...
function RegisterUsers() {
    ...
    return (
        ...
        <Layouts>
            {contextHolder}
            <div style={{ fontFamily: "Inter" }} className="bg-[#F3F4F6] border border-red-600  flex item-center min-h-[85vh] w-full  flex-col">
                <div className="m-1  ">
                    ...
                    <div className='flex flex-col items-center justify-center  sm:mt-8 2xl:mt-32 '>
                        <div className="mx-auto max-w-screen-md py-12 px-4 sm:px-6 md:max-w-screen-xl md:py-15 lg:py-15 md:px-8  xl:w-[50%] w-full">
                            <div className="md:pr-5 md:w-1/1 xl:pr-0 xl:w-1/1 w-full  ">
                                ...
                                <form action="" className="mt-8 border rounded-md shadow-lg p-0">
                                    <div className=" gap-y-4">

                                        <div className="flex items-center  gap-  flex-col md:flex-row">
